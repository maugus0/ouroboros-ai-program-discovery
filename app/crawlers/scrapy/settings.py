"""Scrapy project settings for the Program Discovery Agent."""

BOT_NAME = "program_discovery"
...
ITEM_PIPELINES = {
    "app.crawlers.scrapy.pipelines.ValidateProgramPipeline": 300,
    "app.crawlers.scrapy.pipelines.StoreProgramPipeline": 400,
}
