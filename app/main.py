"""FastAPI application entry point for the Program Discovery Agent."""
...
async def lifespan(_application: FastAPI):
    ...
    await close_pool()
    logger.info("program_discovery_agent_stopped")
...
@app.exception_handler(ProgramDiscoveryBaseError)
async def program_discovery_error_handler(_request: Request, exc: ProgramDiscoveryBaseError):
    return JSONResponse(
