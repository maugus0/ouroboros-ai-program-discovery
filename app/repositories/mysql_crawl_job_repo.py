...
class CrawlJobRepository(MySQLBaseRepository):
    ...
    async def create_job(self, data: dict[str, Any]) -> str:
        ...
        query = """
            INSERT INTO crawl_jobs (
                id, job_type, target_url, target_university_id, status
            ) VALUES (%s, %s, %s, %s, %s)
        """
        params = (
            job_id,
    ...
    async def update_status(
        ...
        programs_crawled: int | None = None,
        programs_updated: int | None = None,
    ) -> int:
        ...
        if programs_crawled is not None:
            set_parts.append("programs_crawled = %s")
            params.append(programs_crawled)

        if programs_updated is not None:
            set_parts.append("programs_updated = %s")
            params.append(programs_updated)
