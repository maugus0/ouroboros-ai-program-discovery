...
def test_is_valid_url_https():
    assert is_valid_url("https://www.mit.edu/programs") is True
...
def test_extract_domain():
    assert extract_domain("https://www.mit.edu/programs/cs") == "mit.edu"
    assert extract_domain("https://stanford.edu/path") == "stanford.edu"
